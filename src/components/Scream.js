...
const Scream = ({ scream: { body, createdAt, userImage, userHandle, screamId, likeCount, commentCount }, classes, user: { likes, authenticated, credentials: { handle } }, likeScream, unlikeScream }) => {
